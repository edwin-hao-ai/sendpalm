...
const D = {
  contacts:[
    {id:'zl',name:'张磊',co:'华为',tl:'战略合作总监',ch:['Gmail','Calendar','WeChat'],sc:94,scC:'#34c759',scL:'活跃',lc:'2天前',grp:'active',em:'zhanglei@huawei.com',ph:'+86 138****1234',trd:'up',topics:['Q4合同','付款条款','交付物定义'],pattern:'通常周二上午发邮件，平均回复 4.2h',accounts:['gmail-w','wechat'],stage:'active',stageHistory:[{stage:'build',date:'2026-01-15'},{stage:'active',date:'2026-03-01'}],firstContact:'2026-01-10',milestones:['合同签署 2026-03-15','Q2评审 2026-06-20'],notes:'Q4 合同推进中，付款条款已调整到 30-40-30。张磊对交付物验收标准比较关注，需提前准备 3 份附件。',photo:'https://picsum.photos/seed/zhanglei/128/128',merged:true},
    {id:'cx',name:'陈欣',co:'字节跳动',tl:'战略合作经理',ch:['Gmail','Slack'],sc:87,scC:'#34c759',scL:'活跃',lc:'今天',grp:'active',em:'chen.xin@bytedance.com',ph:'+86 139****5678',trd:'up',topics:['Q3回顾','Q4规划','API升级'],pattern:'通常下午回复，平均回复 2.1h',accounts:['gmail-w','slack'],stage:'building',stageHistory:[{stage:'explore',date:'2026-04-01'},{stage:'build',date:'2026-05-15'}],firstContact:'2026-04-01',milestones:['Q3合作启动 2026-05'],notes:'Q4 规划基本对齐，整合阶段提前两周需要技术评估。陈欣 Slack 响应很快，紧急事项优先走 Slack。',photo:'https://picsum.photos/seed/chenxin/128/128',merged:true},
    {id:'wy',name:'王洋',co:'阿里巴巴',tl:'采购总监',ch:['Gmail'],sc:34,scC:'#ff9500',scL:'需跟进',lc:'7天前',grp:'risk',em:'wang.yang@alibaba-inc.com',ph:'+86 137****9012',trd:'dn',topics:['Q4提案','预算规划'],pattern:'以前回复很快，近期明显变慢',accounts:['gmail-p','gmail-w'],stage:'cooling',stageHistory:[{stage:'active',date:'2026-01-01'},{stage:'cooling',date:'2026-06-01'}],firstContact:'2025-09-01',milestones:['Q3合同 2025-12'],notes:'45 天未回复 Q4 提案。王总以前回复很快，近期明显变慢，可能内部预算未定。建议下周电话跟进。',photo:'https://picsum.photos/seed/wangyang/128/128',merged:true},
    {id:'lc',name:'李晨',co:'腾讯',tl:'技术VP',ch:['Gmail','WeChat'],sc:18,scC:'#ff3b30',scL:'已冷淡',lc:'14天前',grp:'cold',em:'lichen@tencent.com',ph:'+86 136****3456',trd:'dn',topics:['技术合作','AI方案'],pattern:'之前每月1次沟通，已中断2个月',accounts:['gmail-w','wechat'],stage:'cooling',stageHistory:[{stage:'active',date:'2025-06-01'},{stage:'cooling',date:'2026-05-01'}],firstContact:'2025-03-01',milestones:['AI项目启动 2025-06','一期交付 2026-04'],notes:'已冷淡 62 天。二期立项 busy，建议 2 周后发一份 AI 行业洞察重新激活，不要直接推销。',photo:'https://picsum.photos/seed/lichen/128/128',merged:true},
    {id:'sj',name:'孙静',co:'美团',tl:'产品负责人',ch:['Gmail','Slack'],sc:82,scC:'#34c759',scL:'活跃',lc:'5天前',grp:'active',em:'sunjing@meituan.com',ph:'+86 135****7890',trd:'up',topics:['项目部署','测试计划'],pattern:'Slack响应比邮件快，平均2h',accounts:['gmail-w','slack'],stage:'maintain',stageHistory:[{stage:'build',date:'2025-11-01'},{stage:'active',date:'2026-02-01'},{stage:'maintain',date:'2026-05-01'}],firstContact:'2025-11-01',milestones:['项目Alpha上线 2026-04'],notes:'Alpha 已上线，周五部署前需 review 测试计划。孙静 Slack 响应比邮件快，发票 #1024 已收到，付款期限 30 天。',photo:'https://picsum.photos/seed/sunjing/128/128',merged:true},
    {id:'yy',name:'杨雨',co:'小红书',tl:'商务合作',ch:['Gmail'],sc:76,scC:'#34c759',scL:'活跃',lc:'3天前',grp:'active',em:'yang.yu@xiaohongshu.com',ph:'+86 134****2345',trd:'stable',topics:['联名活动','创意方案'],pattern:'每周1-2次邮件往来',accounts:['gmail-w'],stage:'build',stageHistory:[{stage:'explore',date:'2026-05-01'},{stage:'build',date:'2026-06-01'}],firstContact:'2026-05-01',milestones:[],notes:'联名活动方案内部已过，创意方向 OK，预算需要再压一压。准备一份更轻量级的资源方案。',photo:'https://picsum.photos/seed/yangyu/128/128',merged:true},
    {id:'xm',name:'谢明',co:'京东',tl:'供应链总监',ch:['Gmail','Calendar'],sc:91,scC:'#34c759',scL:'活跃',lc:'1天前',grp:'active',em:'xieming@jd.com',ph:'+86 133****6789',trd:'up',topics:['供应链评估','Q3报告'],pattern:'固定每周一沟通',accounts:['gmail-w'],stage:'maintain',stageHistory:[{stage:'active',date:'2025-08-01'},{stage:'maintain',date:'2026-03-01'}],firstContact:'2025-05-01',milestones:['供应链框架签约 2025-09'],notes:'Q3 供应链评估整体 A-，几个小问题项已标注。明天评审会需带 Q3 报告和 PPT，谢明已发邮箱。',photo:'https://picsum.photos/seed/xieming/128/128',merged:true},
    {id:'lh',name:'刘华',co:'百度',tl:'AI合作负责人',ch:['Gmail','WeChat'],sc:45,scC:'#ff9500',scL:'需跟进',lc:'14天前',grp:'risk',em:'liuhua@baidu.com',ph:'+86 132****0123',trd:'dn',topics:['AI项目','一期验收'],pattern:'项目一期完成后沟通频率下降',accounts:['gmail-p'],stage:'cooling',stageHistory:[{stage:'build',date:'2025-10-01'},{stage:'active',date:'2026-01-01'},{stage:'cooling',date:'2026-06-06'}],firstContact:'2025-10-01',milestones:['AI项目一期启动 2026-01','一期验收 2026-06'],notes:'一期已验收，二期预算在走流程，预计下月初有结果。不要频繁催促，保持月度节奏。',photo:'https://picsum.photos/seed/liuhua/128/128',merged:true},
    {id:'zw',name:'赵薇',co:'网易',tl:'市场总监',ch:['Gmail','Slack'],sc:68,scC:'#34c759',scL:'活跃',lc:'1周前',grp:'active',em:'zhaowei@163.com',ph:'+86 131****4567',trd:'stable',topics:['Q3市场活动','资源支持'],pattern:'每月集中沟通2-3次',accounts:['gmail-w','slack'],stage:'active',stageHistory:[{stage:'build',date:'2026-02-01'},{stage:'active',date:'2026-04-01'}],firstContact:'2026-02-01',milestones:['Q2联合活动 2026-04'],notes:'Q3 活动排期节奏 OK，设计资源下周三到位，文案还需两天。下周一过终稿，需预留半天 review。',photo:'https://picsum.photos/seed/zhaowei/128/128',merged:true},
    {id:'nw',name:'Frontend Weekly',co:'Frontend Weekly',tl:'',ch:['Gmail'],sc:0,scC:'#8e8e93',scL:'',lc:'昨天',grp:'',em:'editor@frontendweekly.com',ph:'',trd:'stable',topics:[],pattern:'每周二发送',accounts:['gmail-p'],stage:'',stageHistory:[],firstContact:'2025-01-01',milestones:[],notes:'技术周刊订阅。',photo:'https://picsum.photos/seed/frontendweekly/128/128',merged:false,defaultBucket:'feed'},
    {id:'aws',name:'Amazon Web Services',co:'AWS',tl:'',ch:['Gmail'],sc:0,scC:'#8e8e93',scL:'',lc:'2天前',grp:'',em:'billing@aws.com',ph:'',trd:'stable',topics:[],pattern:'月度账单与系统通知',accounts:['gmail-w'],stage:'',stageHistory:[],firstContact:'2024-06-01',milestones:[],notes:'AWS 账单与系统通知。',photo:'https://picsum.photos/seed/awsbilling/128/128',merged:false,defaultBucket:'paperTrail'},
    {id:'hr',name:'HR 小助手',co:'SendPalm',tl:'',ch:['Gmail'],sc:0,scC:'#8e8e93',scL:'',lc:'今天',grp:'',em:'hr@sendpalm.com',ph:'',trd:'stable',topics:[],pattern:'内部通知与考勤提醒',accounts:['gmail-w'],stage:'',stageHistory:[],firstContact:'2025-03-01',milestones:[],notes:'公司内部 HR 系统通知。',photo:'https://picsum.photos/seed/hrassistant/128/128',merged:false,defaultBucket:'paperTrail'},
    {id:'mj',name:'马杰',co:'自由职业',tl:'独立开发者',ch:['Gmail','WeChat'],sc:72,scC:'#34c759',scL:'活跃',lc:'3天前',grp:'active',em:'majie@gmail.com',ph:'+86 150****8888',trd:'stable',topics:['开源项目','技术交流'],pattern:'不定期联系',accounts:['gmail-p'],stage:'maintain',stageHistory:[{stage:'active',date:'2025-06-01'},{stage:'maintain',date:'2026-01-01'}],firstContact:'2020-03-15',milestones:[],notes:'老朋友，独立开发者，经常交流技术。',photo:'https://picsum.photos/seed/majie/128/128',merged:true},
    {id:'lp',name:'Lisa Park',co:'Figma',tl:'Product Designer',ch:['Gmail','Slack'],sc:81,scC:'#34c759',scL:'活跃',lc:'2天前',grp:'active',em:'lisa.park@figma.com',ph:'+1 415****8921',trd:'up',topics:['设计系统','组件库','Figma plugin'],pattern:'太平洋时间上午回复，平均 6h',accounts:['gmail-w','slack'],stage:'active',stageHistory:[{stage:'explore',date:'2025-09-01'},{stage:'build',date:'2025-12-01'},{stage:'active',date:'2026-04-01'}],firstContact:'2025-09-01',milestones:['设计系统评审 2026-04'],notes:'Figma 设计系统合作，对组件一致性和无障碍要求很高。沟通以英文为主，重要文档走邮件，日常对齐走 Slack。',photo:'https://picsum.photos/seed/lisapark/128/128',merged:true},
    {id:'tc',name:'Tom Chen',co:'Sequoia Capital',tl:'Investment Partner',ch:['Gmail'],sc:63,scC:'#ff9500',scL:'需跟进',lc:'10天前',grp:'risk',em:'tom.chen@sequoiacap.com',ph:'+1 650****3344',trd:'stable',topics:['融资','商业化','市场数据'],pattern:'回复周期 3-5 天，偏好简洁数据',accounts:['gmail-p'],stage:'build',stageHistory:[{stage:'explore',date:'2026-02-01'},{stage:'build',date:'2026-05-01'}],firstContact:'2026-02-01',milestones:[],notes:'红杉投资人，关注 SendPalm 的商业化路径。需要定期同步关键指标，不要发太长邮件。',photo:'https://picsum.photos/seed/tomchen/128/128',merged:true},
    {id:'sp',name:'SendPalm Support',co:'SendPalm',tl:'',ch:['Gmail'],sc:0,scC:'#8e8e93',scL:'',lc:'昨天',grp:'',em:'support@sendpalm.com',ph:'',trd:'stable',topics:[],pattern:'自动工单 + 人工跟进',accounts:['gmail-w'],stage:'',stageHistory:[],firstContact:'2025-01-01',milestones:[],notes:'产品客服工单系统。',photo:'https://picsum.photos/seed/sendpalmsupport/128/128',merged:false,defaultBucket:'paperTrail'},
    {id:'gh',name:'GitHub',co:'GitHub',tl:'',ch:['Gmail'],sc:0,scC:'#8e8e93',scL:'',lc:'今天',grp:'',em:'notifications@github.com',ph:'',trd:'stable',topics:[],pattern:'代码审查与仓库通知',accounts:['gmail-w'],stage:'',stageHistory:[],firstContact:'2020-01-01',milestones:[],notes:'GitHub 仓库通知。',photo:'https://picsum.photos/seed/githubnotifications/128/128',merged:false,defaultBucket:'paperTrail'},
    {id:'st',name:'Stripe',co:'Stripe',tl:'',ch:['Gmail'],sc:0,scC:'#8e8e93',scL:'',lc:'3天前',grp:'',em:'noreply@stripe.com',ph:'',trd:'stable',topics:[],pattern:'支付与账单通知',accounts:['gmail-w'],stage:'',stageHistory:[],firstContact:'2024-01-01',milestones:[],notes:'Stripe 支付通知。',photo:'https://picsum.photos/seed/stripebilling/128/128',merged:false,defaultBucket:'paperTrail'},
    {id:'mi',name:'小米商城',co:'小米',tl:'',ch:['Gmail'],sc:0,scC:'#8e8e93',scL:'',lc:'5天前',grp:'',em:'order@mi.com',ph:'',trd:'stable',topics:[],pattern:'订单与物流通知',accounts:['gmail-p'],stage:'',stageHistory:[],firstContact:'2023-01-01',milestones:[],notes:'电商订单通知。',photo:'https://picsum.photos/seed/miorders/128/128',merged:false,defaultBucket:'paperTrail'},
    {id:'mom',name:'妈妈',co:'',tl:'',ch:['WeChat'],sc:0,scC:'#34c759',scL:'活跃',lc:'昨天',grp:'active',em:'',ph:'+86 139****0001',trd:'stable',topics:['家庭'],pattern:'日常问候',accounts:['wechat'],stage:'maintain',stageHistory:[],firstContact:'2010-01-01',milestones:[],notes:'家庭群和个人消息。',photo:'https://picsum.photos/seed/momchat/128/128',merged:true,defaultBucket:'imbox'},
    {id:'rec',name:'王猎头',co:'猎聘网',tl:'高级猎头顾问',ch:['Gmail'],sc:0,scC:'#8e8e93',scL:'',lc:'2周前',grp:'',em:'wang.hunter@liepin.com',ph:'+86 138****7777',trd:'stable',topics:[],pattern:'不定期职位推荐',accounts:['gmail-p'],stage:'',stageHistory:[],firstContact:'2025-08-01',milestones:[],notes:'猎头推荐，通常直接进 Records。',photo:'https://picsum.photos/seed/wanghunter/128/128',merged:false,defaultBucket:'feed'},
    {id:'nw2',name:'Lenny\'s Newsletter',co:'Lenny Rachitsky',tl:'',ch:['Gmail'],sc:0,scC:'#8e8e93',scL:'',lc:'4天前',grp:'',em:'lenny@lennysnewsletter.com',ph:'',trd:'stable',topics:[],pattern:'每周产品与管理深度长文',accounts:['gmail-p'],stage:'',stageHistory:[],firstContact:'2024-03-01',milestones:[],notes:'产品订阅通讯。',photo:'https://picsum.photos/seed/lennysnewsletter/128/128',merged:false,defaultBucket:'feed'},
  ],
  ...
  getConnections(pid){const p=this.getP(pid);if(!p)return[];return this.contacts.filter(c=>c.id!==pid&&(c.co===p.co||Math.abs(c.sc-p.sc)<30));},
  getAcct(id){return accounts.find(a=>a.id===id)},
  stageLabel:{explore:'探索期',build:'建立期',active:'活跃期',maintain:'维护期',cooling:'冷淡期',reactivate:'重新激活'},
  stageColor:{explore:'#af52de',build:'#0A8F63',active:'#34c759',maintain:'#5ac8fa',cooling:'#ff3b30',reactivate:'#ff9500'},
  stageSuggest:{cooling:'建议发送问候重新激活',active:'关系健康，保持当前频率',build:'建议安排一次深度交流',maintain:'维持定期沟通节奏',explore:'建议介绍公司和合作方向',reactivate:'建议提供新的价值点'},
  _msgs:[
    // 张磊 - Q4合同线程
  ...
  labels:['Work','Personal','Finance','Travel','Receipts','Newsletters'],
  calendarExtras:{
    dayLabels:{
      '2026-07-18':'放松日',
      '2026-07-19':'评审密集日',
...
(function normalizeData() {
  ...
  const unknownSenders = [
    { id:'unk1', name:'李新锐', co:'未知公司', tl:'商务拓展', em:'lixinrui@example.com', ph:'', topics:[], firstSeen:true, screened:false, defaultBucket:null, notify:false, blocked:false },
    { id:'unk2', name:'Product Hunt', co:'Product Hunt', tl:'', em:'noreply@producthunt.com', ph:'', topics:[], firstSeen:true, screened:false, defaultBucket:null, notify:false, blocked:false },
  ];
