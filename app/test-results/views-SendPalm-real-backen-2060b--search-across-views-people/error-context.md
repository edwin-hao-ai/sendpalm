...
- Name: views.spec.ts >> SendPalm real backend — empty states (no mock data) >> Command palette opens with ⌘K and shows search across views/people
- Location: e2e/views.spec.ts:131:3
...
Locator: getByPlaceholder(/Search views, actions, contacts, messages, files/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByPlaceholder(/Search views, actions, contacts, messages, files/)
